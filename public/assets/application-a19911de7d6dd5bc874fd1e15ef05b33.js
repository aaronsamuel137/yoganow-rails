...
(function() {
  this.api_call = function(query, num_classes, start_time) {
    return $.getJSON('/api?studio=' + query + '&num_classes=' + num_classes + '&start_time=' + start_time, function(data) {
      var class_table, classes, header, link, name;
